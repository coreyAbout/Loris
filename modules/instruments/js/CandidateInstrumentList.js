...
function CandidateInstrumentList(props) {
  var visits = props.Visits.map(function (visit) {
    return React.createElement(_VisitInstrumentList__WEBPACK_IMPORTED_MODULE_0__["default"], {
...
function (_Component) {
  ...
  function VisitInstrumentList(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(VisitInstrumentList).call(this, props));
    _this.state = {
      expanded: false,
      hover: false
    };
  ...
  _createClass(VisitInstrumentList, [{
    ...
    value: function render() {
      ...
      if (!this.state.instruments) {
        ...
        instruments = this.state.instruments.map(function (instrument) {
          ...
          if (instrument.NumOfConflict != 0) {
            conflicterror = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          ...
          }, instrument.Test_name)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("progress", {
            value: instrument.Completion,
            max: "100"
          }, instrument.Completion + '%')), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, conflicterror));
        });

        if (this.state.instruments.length === 0) {
          instruments = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Visit has no registered instruments in test battery.");
        } else {
          instruments = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "Instruments"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("table", {
            className: "table table-hover table-bordered",
            style: {
              width: '95%'
            }
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("thead", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Instrument"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", {
            style: {
              textAlign: 'center'
            }
          }, "Completion"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", {
            style: {
              textAlign: 'center'
            }
          }, "Conflicts?"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, instruments)));
        }
      }
      ...
      if (this.props.Visit.Stages.Visit) {
        vdate = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          style: termstyle
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, "Date Of Visit"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", null, this.props.Visit.Stages.Visit.Date));
        vage = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          style: termstyle
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, "Age"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", null, this.calcAge(this.props.Candidate.Meta.DoB, this.props.Visit.Stages.Visit.Date)));
      }
      ...
      }, this.props.Visit.Meta.Visit))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dl", {
        style: defliststyle
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: termstyle
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, "Subproject"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", null, this.props.Visit.Meta.Battery)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: termstyle
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, "Site"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", null, this.props.Visit.Meta.Site)), vdate, vage, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: termstyle
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, "Status"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", null, vstatus))), instruments)));
    }
  }]);
