    ...
    <div class="row panel panel-default col-xs-6 col-xs-offset-1">
 	...
 	<div class="row panel panel-default col-xs-4 col-xs-offset-1">
		  <div class="panel-body">
		  		<div class="col-xs-12">
		  			<center>
		  				<img src="{$baseurl}/images/preventadlogo.png" class="img-responsive" alt="Responsive image" onerror="this.src='{$baseurl}/images/LORIS_logo.png'" align="middle" width="85%"> 
		  			</center>
					<br>
		  		</div>
